...
public class Demo {
    public static void main(String[] args) {
        ...
        System.out.println("-----------");
        System.out
                .println("limit books of the student2 (limit 3): \n" + studentsApi.getLimitStudentBooks("student2", 3));
        System.out.println("-----------");
        System.out.println("All books : \n" + studentsApi.getAllBooks());
        System.out.println("-----------");
        System.out.println("Show year of the 'book 1' (Optional) if found - 'year' else  'not found' : ");
        studentsApi.showYearOfBookByName("book 1");
        System.out.println("Get the year of the 'book 1' (Optional) if found 'year' else -1 : \n"
